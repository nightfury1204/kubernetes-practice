...
import (
	...
	"kubernetes-practice/k8s-custom-resource/pkg/client/clientset/versioned/scheme"
)
...
func (c *PodwatchersV1alpha1Client) PodWatchers(namespace string) PodWatcherInterface {
	return newPodWatchers(c, namespace)
}
